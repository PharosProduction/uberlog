defmodule Uberlog.Telegram do
  ...
  alias Uberlog.Telegram.{Request, Manager}

  @default_name :telegram
  @default_sender {Request, [:token, :chat_id]}
  ...
  def handle_event({level, _gl, {Logger, msg, ts, md}}, %{level: log_lvl, metadata_filter: filter} = state) do
